...
- 第四、第五章已纳入 `main.tex`；当前整书译稿可由 Tectonic 编译生成 PDF，并已完成交叉引用和版面警告检查。
- 前五章中的原书插图目前以中文概念示意重绘，后续可替换为经许可的图像或更精确的矢量图。
...
当前已纳入完成初译的第一章至第五章。后续章节完成后，在 `main.tex` 中加入相应的 `\include` 即可。
