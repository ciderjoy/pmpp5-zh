...
- 第 11--15 章已接入第二部分“并行模式”，第 16 章已接入第三部分“高级模式与应用”。使用 Tectonic 完整编译整书，最终 PDF 共 321 页；新增六章位于 PDF 物理页 213--315。
- 已渲染并检查新增六章和术语表的全部 109 页，并对章节首页、章节交界、长代码和公式页面进行高分辨率抽检；未发现裁切、重叠、缺字或不可读内容。
